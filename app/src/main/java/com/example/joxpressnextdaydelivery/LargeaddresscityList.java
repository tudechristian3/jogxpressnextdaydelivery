...
public class LargeaddresscityList {

    private String id,psgcCode,citymunDesc,regDesc,provCode,citymunCode;

    public LargeaddresscityList(String id, String psgcCode, String citymunDesc, String regDesc, String provCode, String citymunCode) {
        this.id = id;
