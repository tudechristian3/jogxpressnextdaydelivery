...
public class LargeaddressbarangayList {

    private String id,brgyCode,brgyDesc,regCode,provCode,citymunCode;

    public LargeaddressbarangayList(String id, String brgyCode, String brgyDesc, String regCode, String provCode, String citymunCode) {
        this.id = id;
